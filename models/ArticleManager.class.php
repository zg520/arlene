...
class ArticleManager extends DataManager {
	 ...
	 * @var array
	 */
	public $articleMapping = array('id' => 'id', 'title' => 'title', 'body' => 'text_body', 'coverUrl' => 'cover_uri', 'likes' => 'likes', 'dislikes' => 'dislikes', 'publishDate' => 'publish_date', 'writers' => 'writers');

	public function getById($id) {
		$result = $this -> query("SELECT * FROM `full_articles` WHERE `status` = 'published' AND `id` = ?", array($id));
